namespace Loupedeck.VTuberPlusPlugin
{
    ...
    public class DropInteraction : MultistateActionEditorCommand {
        ...
        public DropInteraction() {
            this.DisplayName = "Drop";
            this.Description = "VTP_Drop";
        ...
        protected override Boolean RunCommand(ActionEditorActionParameters actionParameters) {
            ...
            WebSocketSingleton.Send($"VTP_Drop:{itemIndex}:{customItemIndex}:{damage}");
            return true;
        }
    }
}

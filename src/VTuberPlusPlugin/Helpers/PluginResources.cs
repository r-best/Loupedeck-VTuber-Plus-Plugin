namespace Loupedeck.VTuberPlusPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.VTuberPlusPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.VTuberPlusPlugin.Resources.Resource.txt`.
